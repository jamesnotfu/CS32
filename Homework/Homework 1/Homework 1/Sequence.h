...
{
    public:
        Sequence(int value = DEFAULT_MAX_ITEMS);    // Create an empty sequence (i.e., one whose size() is 0)
        ...
        // leave the sequence unchanged and return -1.  Notice thuat
        ...
        void dump() const;
        // Help print and test the sequences.
